...
| <a name="input_region_code"></a> [region\_code](#input\_region\_code) | Short region code for Azure resource naming, following ALZ naming conventions (e.g., 'eus', 'wus2', 'neu'). | `string` | n/a | yes |
